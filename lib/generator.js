  ...
  try {
    ...
    const failedSelectors = await browserPage.evaluate(() => {
      ...
      [
        ...
        "body main nav + div > div:has(> div > button)", // sign-in (doesn't appear on ToC page)
        "body main nav + div > div:has(> hr)", // horizontal ruler at the bottom of main page content
