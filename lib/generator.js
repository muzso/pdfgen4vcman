  ...
  try {
    ...
    if (isToCPage) {
      ...
      await browserPage.evaluate((titleCaptionStr) => {
        ...
        const headings = document.querySelectorAll("body section#ownersmanual > ul > li > div");
    ...
    const failedSelectors = await browserPage.evaluate(() => {
      ...
      return new Promise((resolve) => {
        ...
        const intervalID = setInterval(() => {
          const titleDivElement = document.querySelector(titleDivSelector);
          if (titleDivElement) {
            if (titleDivElement.previousElementSibling) {
              if (
                ...
                if (titleDivElement.previousElementSibling.querySelector("button") !== null) {
            ...
            result.push(titleDivSelector + " (" + titleDivSelectorCheckCount + ")");
          }
